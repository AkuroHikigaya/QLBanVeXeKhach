...
<body>
  ...
  <main class="align">
    ...
    <h1 class="font-weight-bold text-center">ĐĂNG KÝ THÀNH VIÊN</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form__field">
                            <input autocomplete="fullname" id="register__fullname" type="text" name="fullname" class="form__input" placeholder="Hãy nhập họ tên" required>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form__field">
                            <input autocomplete="phonenumber" id="register__phonenumber" type="text" name="phonenumber" class="form__input" placeholder="Hãy nhập số điện thoại" required>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form__field">
                            <input autocomplete="email" id="register__email" type="text" name="email" class="form__input" placeholder="Hãy nhập email " required>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form__field">
                            <input autocomplete="new_password" id="register__password" type="text" name="new_password" class="form__input" placeholder="Hãy nhập số điện thoại" required>
                        </div>
                    </td>
                </tr>
